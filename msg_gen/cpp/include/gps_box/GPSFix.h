/* Auto-generated by genmsg_cpp for file /home/human/ros_workspace/gps_box/msg/GPSFix.msg */
#ifndef GPS_BOX_MESSAGE_GPSFIX_H
#define GPS_BOX_MESSAGE_GPSFIX_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct GPSFix_ {
  ...
  typedef  ::gps_box::GPSStatus_<ContainerAllocator>  _status_type;
   ::gps_box::GPSStatus_<ContainerAllocator>  status;
  ...
  typedef boost::shared_ptr< ::gps_box::GPSFix_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gps_box::GPSFix_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct GPSFix
typedef  ::gps_box::GPSFix_<std::allocator<void> > GPSFix;

typedef boost::shared_ptr< ::gps_box::GPSFix> GPSFixPtr;
typedef boost::shared_ptr< ::gps_box::GPSFix const> GPSFixConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::gps_box::GPSFix_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::gps_box::GPSFix_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::gps_box::GPSFix_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::gps_box::GPSFix_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::gps_box::GPSFix_<ContainerAllocator> > {
  static const char* value() 
  {
    return "3db3d0a7bc53054c67c528af84710b70";
  }

  static const char* value(const  ::gps_box::GPSFix_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x3db3d0a7bc53054cULL;
  static const uint64_t static_value2 = 0x67c528af84710b70ULL;
};

template<class ContainerAllocator>
struct DataType< ::gps_box::GPSFix_<ContainerAllocator> > {
  static const char* value() 
  {
    return "gps_box/GPSFix";
  }
...
template<class ContainerAllocator>
struct Definition< ::gps_box::GPSFix_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::gps_box::GPSFix_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::gps_box::GPSFix_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::gps_box::GPSFix_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::gps_box::GPSFix_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::gps_box::GPSFix_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
    ...
    s << indent << "status: ";
s << std::endl;
    Printer< ::gps_box::GPSStatus_<ContainerAllocator> >::stream(s, indent + "  ", v.status);
    s << indent << "latitude: ";
...
#endif // GPS_BOX_MESSAGE_GPSFIX_H
